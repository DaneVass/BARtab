...
Output files:
- `merged_reads/<sample_id>/<sample_id>.merged.fastq.gz`: merged reads  
- `merged_reads/<sample_id>/<sample_id>.notCombined_<1,2>.fastq.gz`: reads that could not be merged 
- `merged_reads/<sample_id>/<sample_id>.merge.log`: log
- `merged_reads/<sample_id>/<sample_id>.merge.fastp.json`: log
- `merged_reads/<sample_id>/<sample_id>.merge.fastp.html`: log
...
- `filtered_reads/<sample_id>.filter.fastp.json`: log
- `filtered_reads/<sample_id>.filter.fastp.html`: log
